          ...
          <div className={`${isNavOpen ? 'showMenuNav' : 'hideMenuNav'}`}>
            ...
            <ul className='flex flex-col items-center justify-between min-h-[250px] text-xl font-medium text-secondary'>
              ...
              <li className='flex space-x-2 mt-4'>
                <button onClick={() => changeLanguage('es')} className='px-2 py-1 text-sm font-medium text-gray-800 bg-white rounded hover:bg-gray-200'>
                  {t('header.es')}
                </button>
                <button onClick={() => changeLanguage('en')} className='px-2 py-1 text-sm font-medium text-gray-800 bg-white rounded hover:bg-gray-200'>
                  {t('header.en')}
                </button>
              </li>
            </ul>
