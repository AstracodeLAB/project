        ...
        <div>
          <form id='form' netlify className='space-y-5 px-7 pb-7'>
            ...
            <div className="flex items-center">
                <input id="link-checkbox" required type="checkbox" value="" className="w-4 h-4  bg-gray-100 border-gray-300 rounded focus:ring-secondary dark:focus:ring-accent dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"/>
            ...
            <li><b>Responsable del fichero:</b> XXXXXX <br></br></li>
            <li><b>Legitimación:</b> Consentimiento del usuario. <br></br></li>
            <li><b>Destinatarios:</b> Proveedor mensajería online.<br></br></li>
            <li><b>Finalidad:</b> Responder a su consulta.<br></br></li>
            <li><b>Derechos:</b> Acceder, rectificar y suprimir los datos, así como otros derechos, que puede consultar de forma detallada en nuestra <Link to="/privacy" className="hover:text-blue-500">Política de Privacidad.</Link></li>
            </ul>
          </form>
        </div>
      </div>
